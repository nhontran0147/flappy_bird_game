...
Sau khi đã hoàn thành các bước cài đặt cần thiết ở trên, ta sẽ tải toàn bộ source code về máy. Bằng cách tải theo file zip (game_flappy_bird-main.zip), ta sẽ giải nén file đó ra một folder và chuẩn bị cho bước tiếp theo.
...
## Lưu ý
- Các nút chức năng trong game chỉ nhận chuột trái.
- Nhân vật (chim) trong game được điều khiển bằng cách nhấp chuột trái hoặc nhấn nút space.
